...
Step 1: Verify that each of the {{number_of_notes}} notes includes a clear summary sentence, detailed supporting data, and {{number_of_tags}} appropriate tags, effectively representing the main themes and quantitative data.
